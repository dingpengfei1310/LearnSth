...
- (void)setLeftItemsWithCanGoBack:(BOOL)flag {
    ...
    if (flag) {
        ...
        UIBarButtonItem *closeItem = [[UIBarButtonItem alloc] initWithTitle:DDLocalizedString(@"关闭") style:UIBarButtonItemStylePlain target:self action:@selector(closeController)];
